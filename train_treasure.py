...
data_truth = np.load(data_path + '_truth.npy', allow_pickle=True)
...
train_truth_states = data_truth[train_test_split[int(len(data_truth)*train_test_split_ratio):]]
...
test_truth_states = data_truth[train_test_split[:int(len(data_truth)*train_test_split_ratio)]]
